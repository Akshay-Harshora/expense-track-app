...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.oneitemrecycler,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
         ...
         {
             holder.priority.setBackgroundResource(R.drawable.greenshape);
         }
         ...
         holder.itemView.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 ...
                 i.putExtra("id",transactionModelArrayList.get(position).getId());
                 i.putExtra("amount",transactionModelArrayList.get(position).getAmount());
                 i.putExtra("note",transactionModelArrayList.get(position).getNote());
                 i.putExtra("type",transactionModelArrayList.get(position).getType());
